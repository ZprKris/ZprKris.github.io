...
export default function Experience() {
  return (
    <section className="story-list-section" id="experience" aria-labelledby="experience-heading">
      <p className="eyebrow">Work</p>
      <h2 className="section-heading" id="experience-heading">Selected Experience</h2>
      <ol className="timeline">
        {portfolioData.experience.map((item) => (
          <li className="timeline-item" key={`${item.company}-${item.dates}`}>
            ...
            {item.projectUrl && (
              <a className="text-link" href={item.projectUrl} target="_blank" rel="noreferrer noopener">
